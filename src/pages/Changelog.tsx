      ...
      <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 dark:before:via-slate-800 before:to-transparent">
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-5 rounded-2xl border-2 border-indigo-200 dark:border-indigo-900/60 bg-white dark:bg-slate-900 shadow-sm">
            ...
            <ul className="list-disc pl-5 text-sm space-y-1.5 text-slate-700 dark:text-slate-300">
              <li><strong>Vertical Skill Pathways:</strong> Longitudinal progression across Foundational, Preparatory, Middle, and Secondary stages with official NCF-FS, NCF-SE, and NCERT citations.</li>
              <li><strong>Custom Rubric Builder:</strong> 4-level competency maturity scale (Emerging → Developing → Proficient → Transfer) with anti-orphan validation and printable preview.</li>
              <li><strong>Print-Ready PDF Exports:</strong> High-contrast monochrome exports for lesson and unit plans with track indicators and formal administrative sign-offs.</li>
              <li><strong>Interdisciplinary Theme Bundles (Phase 1):</strong> Three cross-subject inquiry blueprints (Climate, Heritage, Data & Ethics) with read-only browse and one-click cloning into active unit plans.</li>
              <li><strong>Context-Aware Teacher Tips:</strong> Embedded pedagogical strategies for Track A/B/C execution, differentiated instruction, and 40+ student classrooms.</li>
              <li><strong>Technical Self-Audit Report:</strong> Verified routing, WCAG AA contrast compliance, and full type safety across 13 grade profiles.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
            <h3 className="font-bold text-lg text-slate-900 dark:text-white mb-1">CBSE AI Curriculum Tracks Integration</h3>
