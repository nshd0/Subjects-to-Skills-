      ...
      <div className="container mx-auto px-4 max-w-4xl space-y-12">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 shadow-xs space-y-8 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>
              This release represents <strong>v0.8</strong>, introducing 12-state SCERT curricular alignments, a real-time CRDT multi-teacher co-planning studio, a ready-to-use classroom resource bank, low-bandwidth offline vault PWA, and institutional school &amp; district analytics dashboards, alongside universal curriculum mapping across Pre-school to Grade 12. We provide transparent, observable competencies and full flagship activities for priority anchor grades while inviting educators across India to review, test, and contribute feedback.
            </p>
          </section>
